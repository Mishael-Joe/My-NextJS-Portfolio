...
const AboutMe = () => {
  return (
    <section className="about-me" id="about-me">
        <div className="container mx-auto text-slate-300 px-4 pt-20">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-0">
                ...
                <div className="basis-2/4 justify-start font-mono">
                    <p className='pb-4'>I&lsquo;m MISHAEL JOSEPH, a Front-end developer with experience designing and implementing custom front-end pages for clients.</p>
                    ...
                    <div className='pt-8 flex gap-4'>
                        ...
                        <span className='hover:border transition ease-out delay-150 bg-[#0E0762] border-b-4 border-gold-100 rounded h-40 basis-1/3 flex flex-col items-center justify-evenly'>
                            ...
                            <span>Clients</span>
                            <span>20+ Clients <br/> Worldwide</span>
                        </span>
                        <span className='hover:border transition ease-out delay-150 bg-[#0E0762] border-b-4 border-gold-100  rounded h-40 basis-1/3 flex flex-col items-center justify-evenly'>
                            <span><Project /></span>
                            <span>Projects</span>
                    ...
                    <button className='p-2 w-32 rounded bg-blue-600 mt-4 hover:border hover:border-gold-100 hover:text-gold-100'>Let&lsquo;s Talk</button>
                </div>
            </div>
        </div>
    </section>
